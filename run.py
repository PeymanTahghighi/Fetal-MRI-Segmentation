...
if __name__ == "__main__":
    ...
    #dataset_slicer(root_path="C:\\PhD\Courses\\Image Analysis\\Project\\feta_2.1", output_root="C:\PhD\Courses\Image Analysis\Project\Pure");
    entire_dataset = np.array(glob("C:\PhD\Courses\Image Analysis\Project\Pure\\*"));
